# Requirements: Sketch (index)

The Sketch workflow requirements are split into one file per activity:

- [`sketch-overview.md`](sketch-overview.md) — map name, version, authors; read-only canvas
- [`sketch-setup.md`](sketch-setup.md) — bounding box, center placement, mirror mode
